...
class Neracasaldo extends Model
{
    ...
    protected $fillable = ['tahun_periode', 'bulan_periode', 'coa', 'coa_label', 'jenisbayar', 'jenisbayar_label', 'fheader', 'debet', 'credit', 'user_creator_id', 'user_updater_id', 'updated_at'];

                                    ...
                                    @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9 cakfield">
                                                <input type="text" name="deskripsi" class="form-control form-control" id="deskripsi" placeholder="Enter Deskripsi" @if($page_data["page_method_name"] == "View") readonly @endif>
                                            </div>
                                        </div>

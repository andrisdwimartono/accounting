...
<script>
      ...
      //"searching": false,
        ...
        aoColumnDefs: [{
              ...
              mRender: function (data, type, full){
                if(data==0){
                  return "<span class='badge light badge-danger' style='width:50px'>small</span>";
                } else if(data=='1') {
                  return "<span class='badge light badge-warning' style='width:50px'>medium</span>";
                }  else if(data==2) {
                  return "<span class='badge light badge-success' style='width:50px;hieght:50px'>high</span>";
                }
 ...
 function submitform(val_arr, action = 'update'){
  var field_arr = ["id", "deskripsi"];
  cto_loading_show();

  var urlaction = "/updatekebijakan/"+val_arr[0];
  if(action == 'create'){
    urlaction = "/storekebijakan";
  }

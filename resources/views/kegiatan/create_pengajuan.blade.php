                            ...
                            <div class="card-body" style="color: #89879f; padding: 2rem; font-size:0.95rem;">
                                    ...
                                    <form id="quickForm" action="#">
                                        ...
                                        <div class="form-group row justify-content-center">
                                            <div class="col-sm-4">
                                                ...
                                                <button type="button" class="btn btn-danger" id="rejectpengajuan"><i class="fas fa-trash"></i> Tolak</button>
                                                @endif
                                            </div>
                                            <div class="col-sm-4">
                                                <button type="button" class="btn btn-success" id="historypengajuan"><i class="fas fa-list"></i> Histori</button>
                                            </div>
                                            <div class="col-sm-4">
                                                @if(($page_data["lastapprove"] && $page_data["lastapprove"]->role == Auth::user()->role_label) || ($page_data["nextapprove"] && $page_data["nextapprove"]->role == Auth::user()->role_label))
                                                <button type="button" class="btn btn-primary" id="approvepengajuan"><i class="fas fa-check"></i> Terima</button>
                                                @endif
                                            </div>
                                        </div>
                                        @endif
                                ...
                                <div class="modal fade" id="modal-reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger" id="rejectpengajuan-confirmed">Tolak</button>
                                ...
                                <div class="modal fade" id="modal-accept" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Apakah anda yakin terima Pengajuan ini?</p>
                                            </div>
                                            <div class="modal-footer">
                                ...
                                <div class="modal fade" id="modal-history" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><b>History Pengajuan</b></h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            </div>

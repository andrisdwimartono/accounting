...
<head>
    ...
    <title>ACC | {{$page_data["page_method_name"]}} {{$page_data["page_data_name"]}}</title>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset ("/assets/motaadmin/images/avatar/1.jpg") }} " class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset ("/assets/motaadmin/images/avatar/2.jpg") }} " class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset ("/assets/motaadmin/images/avatar/3.jpg") }} " class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset ("/assets/motaadmin/images/avatar/4.jpg") }} " class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset ("/assets/motaadmin/images/avatar/5.jpg") }} " class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ asset ("/assets/motaadmin/images/avatar/1.jpg") }} " class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{ asset ("/assets/motaadmin/images/avatar/2.jpg") }} " class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="nav menu-tabs">
					<li class="nav-item">
						<a class="nav-link" id="cakmenuparentmaster" data-toggle="tab" href="#cakmenumaster">
					...
					<li class="nav-item">
						<a class="nav-link" id="cakmenuparenttransactions" data-toggle="tab" href="#cakmenutransactions">

        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="nav menu-tabs">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#cakmenu-dashboard">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#cakmenu-master">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#cakmenu-transaksi">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#cakmenu-laporan">

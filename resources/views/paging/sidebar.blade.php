            ...
            <div class="deznav-scroll">
				<ul class="nav menu-tabs">
					<li class="nav-item"  data-toggle="tooltip" data-placement="right" title="Dashboard">
						<a class="nav-link" id="caknav-dashboard" data-toggle="tab" href="#cakmenu-dashboard">
					...
					<li class="nav-item"  data-toggle="tooltip" data-placement="right" title="Master">
						<a class="nav-link" id="caknav-master" data-toggle="tab" href="#cakmenu-master">
					...
					<li class="nav-item"  data-toggle="tooltip" data-placement="right" title="Jurnal">
						<a class="nav-link"  id="caknav-transaksi" data-toggle="tab" href="#cakmenu-transaksi">
					...
					<li class="nav-item"  data-toggle="tooltip" data-placement="right" title="Laporan">
						<a class="nav-link"  id="caknav-laporan" data-toggle="tab" href="#cakmenu-laporan">
					...
					<li class="nav-item"  data-toggle="tooltip" data-placement="right" title="E-budgeting">
						<a class="nav-link"  id="caknav-ebudgeting" data-toggle="tab" href="#cakmenu-ebudgeting">
					...
					<li class="nav-item"  data-toggle="tooltip" data-placement="right" title="Setting">
						<a class="nav-link" id="caknav-settings" data-toggle="tab" href="#cakmenu-settings">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon" stroke="currentColor" fill="none">
								...
								<path d="M16.6568542,5.92893219 L18.0710678,7.34314575 C18.4615921,7.73367004 18.4615921,8.36683502 18.0710678,8.75735931 L16.6913928,10.1370344 C16.3008685,10.5275587 15.6677035,10.5275587 15.2771792,10.1370344 L13.8629656,8.7228208 C13.4724413,8.33229651 13.4724413,7.69913153 13.8629656,7.30860724 L15.2426407,5.92893219 C15.633165,5.5384079 16.26633,5.5384079 16.6568542,5.92893219 Z" fill="#ffffff" opacity="0.3"/>
						</svg>
						</a>
					</li>
				</ul>

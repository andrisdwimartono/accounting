...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="{{ asset ("/assets/motaadmin/images/favicon.png") }}" />
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{ asset ("/assets/motaadmin/images/avatar/1.jpg") }} ">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ asset ("/assets/motaadmin/images/profile/pic1.jpg") }} " width="20" alt=""/>

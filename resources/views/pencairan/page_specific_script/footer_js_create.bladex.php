...
$("#quickForm").validate({
    ...
    messages: {
        unitkerja_code :{
            ...
            minlength: "Kode Unit Kerja minimal 1 karakter!!",
            maxlength: "Kode Unit Kerja maksimal 5 karakter!!"
        },
        unitkerja_name :{
            required: "Nama Unit Kerja harus diisi!!",
            minlength: "Nama Unit Kerja minimal 2 karakter!!",
            maxlength: "Nama Unit Kerja maksimal 255 karakter!!"
        },
    },
    errorElement: "span",

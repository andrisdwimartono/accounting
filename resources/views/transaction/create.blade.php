                            ...
                            @csrf
                                <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 cakfield">
                                                <input type="text" name="journal_number" class="form-control" id="journal_number" placeholder="Enter Nomor Jurnal" @if($page_data["page_method_name"] == "View") readonly @endif>
                                            </div>
                                        </div>
                                        <div class="form-group row">

                            ...
                            @csrf
                                <div class="card-body">
                                        ...
                                        <div class="form-group row m-0">
                                            ...
                                            <div class="col-sm-6 cakfield">
                                                <input type="text" name="journal_number" class="form-control form-control-sm" id="journal_number" placeholder="Enter Nomor Jurnal" readonly @if($page_data["page_method_name"] == "View") readonly @endif>
                                            </div>
                                        </div>
                                        <div class="form-group row m-0">
                                            <label class="col-sm-4 col-form-label" for="anggaran_name">Nama Anggaran</label>
                                            <div class="col-sm-6 cakfield">
                                                <input type="text" name="anggaran_name" class="form-control form-control-sm" id="anggaran_name" placeholder="Enter Nama Anggaran" @if($page_data["page_method_name"] == "View") readonly @endif>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row m-0">
                                            ...
                                            <div class="col-sm-6" id="reservationdatetime_transaction_date" data-target-input="nearest">
                                                <input type="text" name="transaction_date" id="transaction_date" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime_transaction_date">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row m-0">
                                        ...
                                        <div class="col-sm-6 cakfield">
                                            <textarea name="description" class="form-control form-control-sm" id="description" placeholder="Enter Keterangan" @if($page_data["page_method_name"] == "View") readonly @endif></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row m-0">
                                        <label class="col-sm-4 col-form-label" for="transaction_type">Jenis Transaksi</label>
                                        <div class="col-sm-6 cakfield">
                                            <select name="transaction_type" id="transaction_type" class="form-control form-control-sm select2bs4" style="width: 100%;" @if($page_data["page_method_name"] == "View") readonly @endif>

                                            </select>
                                            <input type="hidden" name="transaction_type_label" id="transaction_type_label">
                                        </div>
                                    </div>
                                    <input type="hidden" name="transaction_detail" class="form-control form-control-sm" id="transaction_detail" placeholder="Enter Menu Field" @if($page_data["page_method_name"] == "View") readonly @endif>
                                    ...
                                    <form id="quickModalForm_transaction_detail" action="#">
                                            <div class="form-group row m-0">
                                                ...
                                                <div class="col-sm-6 cakfield">
                                                    <select name="coa" id="coa" class="form-control form-control-sm select2bs4staticBackdrop" style="width: 100%;" @if($page_data["page_method_name"] == "View") readonly @endif>
                                            ...
                                            <div class="form-group row m-0">
                                                ...
                                                <div class="col-sm-6 cakfield">
                                                    <input type="text" name="description" class="form-control form-control-sm" id="description" placeholder="Enter Deskripsi" @if($page_data["page_method_name"] == "View") readonly @endif>
                                                </div>
                                            </div>
                                            <div class="form-group row m-0">
                                                <label class="col-sm-4 col-form-label" for="debet">Debet</label>
                                                <div class="col-sm-6 cakfield">
                                                    <input type="text" name="debet" value="0" class="form-control form-control-sm cakautonumeric cakautonumeric-float" id="debet" placeholder="Enter Debet" @if($page_data["page_method_name"] == "View") readonly @endif>
                                                </div>
                                            </div>
                                            <div class="form-group row m-0">
                                                <label class="col-sm-4 col-form-label" for="credit">Kredit</label>
                                                <div class="col-sm-6 cakfield">
                                                    <input type="text" name="credit" value="0" class="form-control form-control-sm cakautonumeric cakautonumeric-float" id="credit" placeholder="Enter Kredit" @if($page_data["page_method_name"] == "View") readonly @endif>
                                                </div>
                                            </div>
                                            <div class="form-group row m-0">
                                                <label class="col-sm-4 col-form-label" for="va_code">Kode VA</label>
                                                <div class="col-sm-6 cakfield">
                                                    <input type="text" name="va_code" class="form-control form-control-sm" id="va_code" placeholder="Enter Kode VA" @if($page_data["page_method_name"] == "View") readonly @endif>
                                                </div>
                                            </div>
